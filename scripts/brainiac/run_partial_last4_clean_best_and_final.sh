#!/bin/bash
#SBATCH --job-name=ptft4clean
#SBATCH --output=/scratch/jbayasi/Cavmalproject1/logs/ptft4clean_%j.out
#SBATCH --error=/scratch/jbayasi/Cavmalproject1/logs/ptft4clean_%j.err
...
echo "===== START CLEAN PARTIAL FT LAST 4 BLOCKS ====="
date
hostname
nvidia-smi

OUTPUT_BASE="/scratch/jbayasi/Cavmalproject1/results/partial_finetune_clean_last4blocks_150ep_best_and_final"

for FOLD in 0 1 2 3 4
do
    echo ""
    echo "============================================================"
    echo "RUNNING LAST 4 BLOCKS | FOLD ${FOLD}"
    echo "============================================================"
    date
...
echo "===== DONE CLEAN PARTIAL FT LAST 4 BLOCKS ====="
date
